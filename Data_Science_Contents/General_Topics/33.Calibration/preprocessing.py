...
def create_preprocessor(features_dict):
    ...
    num_zero = features_dict['num_zero']
...
def transform_datasets(fit_transformers, features_dict, X):
    ...
    num_zero_transformer = fit_transformers['num_zero']
    ...
    X_new = pd.concat(
        [
            ...
            pd.DataFrame(num_zero_transformer.transform(X[num_zero])),
